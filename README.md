...
| 004 | [Interior-Design](https://github.com/wsantos-ai/interior-design.git) | Next.js 15 (App Router) + React 19 + TypeScript, Tailwind CSS 4, Gemini API | Aplicação web de página única que transforma o interior de ambientes com Inteligência Artificial. |
...
├── 004-interior-design/   # Interior Design (Next.js 15 (App Router) + React 19 + TypeScript, Tailwind CSS 4, Gemini API)
